...
export const initiateCheckInSchema = z
  .object({
    bookingId: z.string().uuid(),
    passengerId: z.string().uuid(),
  })
  .openapi("InitiateCheckInInput");

export const passportScanSchema = z
  .object({
  ...
  .openapi("PassportScanInput");

export const seatSelectionSchema = z
  .object({
    seatId: z.string().uuid(),
  })
  .openapi("SeatSelectionInput");
